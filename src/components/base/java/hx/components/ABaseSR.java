...
public abstract class ABaseSR extends ABase {
    ...
    private SwipeRefreshLoader mSwipeRefreshLoader;

    public abstract SwipeRefreshLoader getSwipeRefreshLoader(SwipeRefreshContainer _sr_container, RecyclerView _rv);
