...
public class LineItem2 extends RelativeLayout {
    ...
    public LineItem2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LineItem2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    private void init(Context ctx, AttributeSet attrs){
        View layout = inflate(ctx, R.layout.l_lineitem, this);
